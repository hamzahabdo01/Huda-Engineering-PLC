        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex gap-2">
              <button title="English" onClick={() => handleLanguageChange("en")} className={`p-1 rounded border transform transition-transform hover:scale-110 ${languageInfo.current === "en" ? "bg-primary text-white" : "bg-white"}`}><UKFlag /></button>
              <button title="Amharic" onClick={() => handleLanguageChange("am")} className={`p-1 rounded border transform transition-transform hover:scale-110 ${languageInfo.current === "am" ? "bg-primary text-white" : "bg-white"}`}><EthiopiaFlag /></button>
            </div>
            ...
            <button className="md:hidden p-2 rounded-md text-foreground hover:text-primary hover:bg-muted" onClick={toggleMenu}>
